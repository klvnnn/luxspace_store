                    ...
                    <div className="w-auto">
                        ...
                        >
                            <li className="mx-3 py-6 md:py-0">
                                <Link to="/showcase" className="font-semibold md:text-white hover:text-black hover:font-semibold">Showcase</Link>
                            </li>
                            <li className="mx-3 py-6 md:py-0">
                                <Link to="/catalog" className="font-semibold md:text-white hover:text-black hover:font-semibold">Catalog</Link>
                            </li>
                            <li className="mx-3 py-6 md:py-0">
                                <Link to="/delivery" className="font-semibold md:text-white hover:text-black hover:font-semibold">Delivery</Link>
                            </li>
                            <li className="mx-3 py-6 md:py-0">
                                <Link to="/rewards" className="font-semibold md:text-white hover:text-black hover:font-semibold">Rewards</Link>
                            </li>
                        </ul>
                    </div>
                    <div className="w-auto">
